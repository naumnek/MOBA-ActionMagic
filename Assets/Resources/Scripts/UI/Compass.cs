...
namespace Platinum.UI
{
    public class Compass : MonoBehaviour
    {
        ...
        void Awake()
        {
            ControllerPlayer controller = FindObjectOfType<ControllerPlayer>();
            DebugUtility.HandleErrorIfNullFindObject<CharacterAvatar, Compass>(controller,
                this);
            m_PlayerTransform = controller.Movement.Body;
