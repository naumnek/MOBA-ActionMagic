...
{
    public class ManaAmmoCounter : MonoBehaviour
    {
        ...
        [Tooltip("Text for Weapon index")] public TMP_Text WeaponIndexText;

        [Tooltip("Image for the weapon infinity ammo icon")]
        public Image CarriedInfinityAmmoIcon;

        [Tooltip("Text for Bullet Counter")] public TMP_Text CurrentBulletsCounter;
        ...
        void Update()
        {
            ...
            WeaponImage.color =
                weapon.activeBullet.GetCarriedAmmo() > 0 && weapon.ActiveGunBullet.GetCurrentBullets() == 0 &&
